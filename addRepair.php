	...
	<body id="top" style="font-size: 62.5%;">
		...
		<div class="main clearfix">
			...
			<div class="bread">
				<div class="submenu">
					<ul>
						<li id="back"><a href="##" onClick="history.go(-1); return false;">Trở lại</a></li>
						
					</ul>
				</div>
				<h3><a style="text-decoration: none;" href="repairs.php">Sửa Chữa</a></h3> <span style="font-size: 1.2em; font-weight: 500">\Thêm Sửa Chửa</span>
			</div>
			<!--Breadcrumb -->
				...
				<div class=" full-widget">
						...
						<div class="row">
							<div class="col-md-12" ng-show="filteredItems > 0">
								<table class="table table-striped table-bordered">
									<thead>
										<th>Kh_id&nbsp;<a ng-click="sort_by('Kh_id');"><i class="glyphicon glyphicon-sort"></i></a></th>
										<th>Ten&nbsp;<a ng-click="sort_by('Ten');"><i class="glyphicon glyphicon-sort"></i></a></th>
										<th>Ho&nbsp;<a ng-click="sort_by('Ho');"><i class="glyphicon glyphicon-sort"></i></a></th>
										<th>Huyen&nbsp;<a ng-click="sort_by('Huyen');"><i class="glyphicon glyphicon-sort"></i></a></th>
										<th>ThanhPho&nbsp;<a ng-click="sort_by('ThanhPho');"><i class="glyphicon glyphicon-sort"></i></a></th>
										<th>Sdt&nbsp;<a ng-click="sort_by('Sdt');"><i class="glyphicon glyphicon-sort"></i></a></th>
									</thead>
									<tbody>
					...
					<div>
						<form class="form-4" method="post" action="addRepairForm.php">	
							<p>Nhập ID khách hàng muốn sửa chữa:</p> <br>
							<input type="number" name="record" placeholder="Nhập Id:" min="1" maxlength="10" required>
							<input type="submit" name="go" value="Sửa Chữa Form>>">	
						</form>
					</div>
