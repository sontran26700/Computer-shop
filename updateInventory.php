			...
			<div class="bread dash">
				<div class="submenu">
					<ul>
						...
						<li id="add"><a href="addInventory.php">Thêm Item mới</a></li>
					</ul>
				</div>
				<h3><a style="text-decoration: none;" href="inventory.php">Quản Lí Kho</a></h3> <span style="font-size: 1.2em; font-weight: 500">\ Cập Nhập Kho</span>
			</div>
			<!--Breadcrumb -->
