	...
	<body id="top" style="font-size: 62.5%;">
		...
		<div class="main clearfix">
			...
			<div class="bread">
				<div class="submenu">
					<ul>
						<li id="update" value="Update Repair">Cập Nhập Sửa Chữa</li>
						<li id="add"><a href="addRepair.php">Thêm Sửa Chữa</a></li>
					</ul>
				</div>
				<h3>Sửa Chữa</h3>
			</div>
							...
							<div class="col-md-12" ng-show="filteredItems > 0">
								<table class="table table-striped table-bordered">
									<thead>
										...
										<th>Cập Nhập Ngày&nbsp;<a ng-click="sort_by('collectiondate');"><i class="glyphicon glyphicon-sort"></i></a></th>
