			...
			<div class="bread dash">
				<div class="submenu">
					<ul>
						...
						<li id="add"><a href="addRepair.php">Thêm Sửa Chữa Mới</a></li>
					</ul>
				</div>
				<h3><a style="text-decoration: none;" href="repairs.php">Sửa Chữa</a></h3> <span style="font-size: 1.2em; font-weight: 500">\ Cập Nhập Sửa Chữa</span>
			</div>
			<!--Breadcrumb -->
