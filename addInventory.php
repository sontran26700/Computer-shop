	...
	<body id="top" style="font-size: 62.5%;">
		...
		<div class="main clearfix">
			...
			<div class="bread dash">
				...
				<h3><a style="text-decoration: none;" href="inventory.php">Quản Lí Kho</a></h3> <span style="font-size: 1.2em; font-weight: 500">\ Thêm sản phẩm</span>
			</div>
			<!--Breadcrumb -->
			...
			<div class="floats">
				<div class="full-widget">		
					...
					<form class="form-4" action="" method="post">
						<h1>Thêm sản phẩm mới vào kho: </h1>
						<span id="msg">
							<?php 
								echo $success; 
								echo $error;
						...
						<input type="text" name="price" placeholder="Giá cả" required>
